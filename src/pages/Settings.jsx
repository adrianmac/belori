...
// ─── INTEGRATIONS TAB ────────────────────────────────────────────────────────
// Extracted to src/pages/settings/IntegrationsTab.jsx and lazy-loaded.
// Split out of the 4000-line Settings.jsx — saves ~30 KB on the Settings
// chunk for boutiques that never visit this tab.
const IntegrationsTab = React.lazy(() => import('./settings/IntegrationsTab'));
      ...
      <div style={{flex:1,display:'flex',overflow:'hidden'}}>
        ...
        <div style={{flex:1,overflowY:'auto',padding:20}}>
          ...
          {activeTab === 'integrations' && (
            <React.Suspense fallback={<div style={{padding:32,textAlign:'center',color:C.gray,fontSize:13,fontFamily:"'Cormorant Garamond',serif",fontStyle:'italic'}}>Loading integrations…</div>}>
              {hasProPlan
                ? <IntegrationsTab/>
