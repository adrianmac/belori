      ...
      {alerts.length === 0 ? (
        ...
        return (
          <button type="button" key={alert.id} onClick={() => handleClick(alert)}
            ...
            style={{ display: 'flex', alignItems: 'flex-start', gap: 10, padding: '11px 14px', cursor: 'pointer', borderBottom: i < alerts.length - 1 ? `1px solid ${C.border}` : 'none', borderTop: 'none', borderLeft: 'none', borderRight: 'none', background: 'transparent', width: '100%', textAlign: 'left', transition: 'background 0.1s' }}
            ...
            <svg width="10" height="10" viewBox="0 0 16 16" fill="none" style={{ flexShrink: 0, marginTop: 6, color: C.gray }} aria-hidden="true">
