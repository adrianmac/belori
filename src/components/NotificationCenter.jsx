      ...
      {alerts.length === 0 ? (
        ...
        return (
          <button key={alert.id} onClick={() => handleClick(alert)}
            style={{ display: 'flex', alignItems: 'flex-start', gap: 10, padding: '11px 14px', cursor: 'pointer', border: 'none', borderBottom: i < alerts.length - 1 ? `1px solid ${C.border}` : 'none', background: 'transparent', width: '100%', textAlign: 'left', transition: 'background 0.1s' }}
