      ...
      {alerts.length === 0 ? (
        ...
        return (
          <button key={alert.id} onClick={() => handleClick(alert)}
            style={{ display: 'flex', alignItems: 'flex-start', gap: 10, padding: '11px 14px', cursor: 'pointer', background: 'transparent', borderTop: 'none', borderLeft: 'none', borderRight: 'none', borderBottom: i < alerts.length - 1 ? `1px solid ${C.border}` : 'none', width: '100%', textAlign: 'left', fontFamily: 'inherit', transition: 'background 0.1s' }}
