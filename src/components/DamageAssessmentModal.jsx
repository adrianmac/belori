    ...
    >
      ...
      >
        ...
        <div style={{ padding: '18px 24px', borderBottom: `1px solid ${C.border}`, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexShrink: 0 }}>
          ...
          <button onClick={onClose} aria-label="Close" title="Close" style={{ background: 'none', border: 'none', fontSize: 22, color: C.gray, cursor: 'pointer', lineHeight: 1, padding: 0, marginTop: 2 }}>×</button>
        </div>
