          ...
          <div>
            ...
            {imagePreview?(
              <div style={{position:'relative',display:'inline-block'}}>
                ...
                <button onClick={()=>{setImageFile(null);setImagePreview(null);}} style={{position:'absolute',top:6,right:6,background:'rgba(0,0,0,0.55)',border:'none',borderRadius:'50%',width:24,height:24,color:'#fff',cursor:'pointer',fontSize:14,lineHeight:'24px',textAlign:'center'}} aria-label="Remove image" title="Remove image">×</button>
              </div>
            ):(
